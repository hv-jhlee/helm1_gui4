...
class MainTabData:
    def __init__(self):
        ...
        self.dic_ch_list = (768, 804, 864, 960)
...
class I2CTabData:
    def __init__(self):
        ...
        self.v.i2c_slave_addr = StringVar(None, "54")
        self.v.i2c_access_addr = StringVar(None, "80 00")
        self.v.i2c_write = StringVar(None, "00")
        self.v.i2c_read_num = StringVar(None, "1")
...
class EEPROMTabData:
    def __init__(self):
        ...
        self.v.eep_slave_addr = StringVar(None, "51")
        self.v.eep_access_addr = StringVar(None, "00 00")
        self.v.eep_write = StringVar()
        self.v.eep_read = StringVar()
        self.v.eep_read_num = StringVar(None, "1")
        self.v.eep_pg_id = StringVar()
        self.v.eep_pg_len = StringVar()
        self.v.eep_crc_read = StringVar()
        self.v.eep_crc_sum = StringVar()
        self.v.eep_crc_ofs = StringVar(None, "FE")
        self.v.eep_next_pg = StringVar()
        self.v.eep_write_1 = StringVar()
        self.v.eep_write_list = StringVar()
        self.v.eep_check_mod = StringVar()
        self.v.eep_pri_main = StringVar(None, "4A")
        self.v.eep_pri_core = StringVar(None, "ED 49 96 80 95")
        self.v.eep_pri_base = StringVar(None, "40 41 42 84 82 98 99 9A")
        self.v.eep_import_rom = StringVar()
        self.v.eep_conc = StringVar()
        self.v.eep_txt_main = StringVar()
        self.v.eep_txt_core = StringVar()
        self.v.eep_txt_base = StringVar()
        self.v.eep_txtfile = (StringVar(), StringVar())
        self.v.sub20_pages = StringVar()
        self.v.sub20_pg_num = StringVar()
        self.v.sub20_total_len = StringVar()
        self.v.eep_check = IntVar()
